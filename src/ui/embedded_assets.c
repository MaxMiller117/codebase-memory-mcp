...
extern const unsigned char _binary_assets_index_Cxkow1vC_css_start[];
extern const unsigned char _binary_assets_index_Cxkow1vC_css_end[];
extern const unsigned char _binary_assets_index_DcOJ9L9__js_start[];
extern const unsigned char _binary_assets_index_DcOJ9L9__js_end[];
...
cbm_embedded_file_t CBM_EMBEDDED_FILES[] = {
    {"/assets/index-Cxkow1vC.css", _binary_assets_index_Cxkow1vC_css_start, 0, "text/css"},
    {"/assets/index-DcOJ9L9_.js", _binary_assets_index_DcOJ9L9__js_start, 0, "application/javascript"},
...
static void __attribute__((constructor)) init_embedded_sizes(void) {
    ...
    files[0].size = (unsigned int)(_binary_assets_index_Cxkow1vC_css_end - _binary_assets_index_Cxkow1vC_css_start);
    files[1].size = (unsigned int)(_binary_assets_index_DcOJ9L9__js_end - _binary_assets_index_DcOJ9L9__js_start);
